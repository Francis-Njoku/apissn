        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-bordered">
              <thead>
                <tr>
                  <th class="sorting" data-sorting_type="asc" data-column_name="category" style="cursor: pointer">
              ...
              <tbody>
                @include('dashboard.admin_forum_pagination_data')
              </tbody>
            </table>
            <input type="hidden" name="hidden_page" id="hidden_page" value="1" />
            <input type="hidden" name="hidden_column_name" id="hidden_column_name" value="category" />
        ...
        <div class="modal-content">
          ...
          <form method="POST" action="{{ route('admin-store-category') }}" accept-charset="UTF-8" id='contactForm'
            ...
            <div class="modal-body">
              ...
              <input type="text" name="description" class=" form-control mb-4" placeholder="Short description" required />
        ...
        <div class="modal-content">
          ...
          <form method="POST" action="{{ route('admin-update-category') }}" accept-charset="UTF-8" id='contactForm'
            ...
            <div class="modal-body">
              ...
              <input value="category" type="text" id="category" name="category" class="category form-control mb-4" placeholder="Category" required />
