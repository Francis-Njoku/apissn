    ...
    <div class="col-xl-21 col-lg-12">
      <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Upload Newsletter</h6>

        </div>
        <!-- Card Body -->

        <div class="card-body">
          <form method="POST" action="{{ route('admin-store') }}" accept-charset="UTF-8" id='contactForm'
            ...
            <input type="date" name="news_date" class=" form-control mb-4" placeholder="Date" required />

            <input type="text" name="title" class=" form-control mb-4" placeholder="Title" required />
            <input type="text" name="name" class=" form-control mb-4" placeholder="Newsletter caption" required />
