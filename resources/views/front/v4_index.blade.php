                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-7">
                        <div class="title-heading mt-4">
                            <h1 class="heading mb-3">Become a smart investor <br>For Your Project</h1>
                            <p class="para-desc text-muted">Discover market-beating stocks, learn to invest
                                 with confidence, and get insights into the factors that drive capital appreciation</p>
                            <div class="mt-4 pt-2">
                                <a href="/pricing" class="btn btn-primary m-1">Subscribe now</a>
                                <a href="https://www.youtube.com/watch?v=CK7xWekl5hI&list=PLGFQNga51Xht9ot3HMNuWRzCZ_nXj6I3m" target="_blank" class="btn btn-icon btn-pills btn-primary m-1 lightbox"><i data-feather="video" class="icons"></i></a><a href="https://www.youtube.com/watch?v=CK7xWekl5hI&list=PLGFQNga51Xht9ot3HMNuWRzCZ_nXj6I3m" target="_blank"><span class="fw-bold text-uppercase small align-middle ms-2">Watch Webinars</span></a>
                            </div>
                        </div>
                    </div><!--end col-->

                    <div class="col-lg-5 col-md-5 mt-4 pt-2 mt-sm-0 pt-sm-0">
                        <img class="img-fluid" src="{{ url('/assetz/images/home/stock-select-first.png') }}" alt="">
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
        </section><!--end section-->
                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="features feature-primary text-center">
                            ...
                            <div class="content mt-4">
                                <h5>Get at least two stock recommendation monthly</h5>
                                <p class="text-muted mb-0">Get exclusive market intelligence on stocks and market in general</p>
                            </div>
                        </div>
                    </div><!--end col-->
                    ...
                    <div class="col-md-6 col-12 mt-5 mt-sm-0">
                        <div class="features feature-primary text-center">
                            ...
                            <div class="content mt-4">
                                <h5>Monthly Buy, Sell or Hold Recommendations</h5>
                                <p class="text-muted mb-0">Succinctly written analysis of company results and corporate actions</p>
                            </div>
                        </div>
                    </div><!--end col-->
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 order-2 order-md-1 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title me-lg-5">
                            <h4 class="title mb-4">Read Latest Economic and Financial Analysis</h4>
                            <p class="text-muted">Destination for Business news and analysis from Africa's largest economy</p>
                            <a href="https://nairametrics.com" class="btn btn-outline-primary">Visit Now <i class="uil uil-angle-right-b"></i></a>
                        </div>
                    </div><!--end col-->

                    <div class="col-md-6 order-1 order-md-2">
                        <img src="{{ url('/assetz/images/home/nairametrics-site.png') }}" class="img-fluid" alt="">
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
                ...
                <div class="row justify-content-center" id="counter">
                    <div class="col-md-4 mt-4 pt-2">
                        <div class="counter-box text-center px-lg-4">
                            ...
                            <h5 class="counter-head">Happy Subscribers</h5>
                    ...
                    <div class="col-md-4 mt-4 pt-2">
                        <div class="counter-box text-center px-lg-4">
                            <h2 class="mb-0 text-primary display-4"><span class="counter-value" data-target="100">1</span>+</h2>
                            <h5 class="counter-head">Stock Select</h5>
                            <p class="text-muted mb-0"></p>
                        </div><!--end counter box-->
                    </div><!--end col-->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="section-title ms-lg-5">
                            <h4 class="title mb-4">Get complete access to all previous newsletters including ones that published before you subscribed.</h4>
                            <p class="text-muted">Remember to seek further information from your financial adviser should you ever have doubts about what stock to buy, sell or hold.</p>
                            <a href="/get-newsletter" class="btn btn-outline-primary">Get Now <i class="uil uil-angle-right-b"></i></a>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
