    ...
    <div class="row m-auto text-center w-75">
        ...
        <div class="col-md-12 princing-item red">
            <div class="pricing-divider ">
                ...
                <h4 class="my-0 display-4 text-light font-weight-normal mb-3"><span class="h3">&#8358;</span> 25,000
            ...
            <div class="card-body bg-white mt-0 shadow">
                <ul class="list-unstyled mb-5 position-relative">
                    <li>Monthly Recommendations on Agro-Tech investments</li>
                    <li>Corporate Profiles on Fund Providers</li>
                    <li>Investment Analysis</li>
                    <li>Cash and Food Crop Analysis</li>
                </ul>
                @guest
                ...
                <form method="POST" action="{{ route('pay') }}" accept-charset="UTF-8" class="form-horizontal"
                    ...
                    <input type="hidden" name="metadata" value="{{ json_encode($array = ['plan_type' => '35',]) }}">
